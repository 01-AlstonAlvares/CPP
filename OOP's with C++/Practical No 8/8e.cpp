// Practical-8.(e)
// Aim:Write a C++ program to perform read/write binary I/O
// operation on a file(i.e. write the object of a structure/class
// to file).
// Algorithm:(i)Start
//  (ii)ostream& write(const char*, int);
//  (iii)ifstream& write(const char*, int);
//  (iv)Print the result
//  (v)Stop
// Theory:In this practical,we will perform read/write binary
// I/O operation on a file
Program:
#include<iostream>
#include<fstream>
using namespace std;
